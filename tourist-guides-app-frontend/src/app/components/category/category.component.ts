...
import { CategoryInsertFormComponent } from './category-insert-form/category-insert-form.component';
...
export class CategoryComponent {
  ...
  // for Update - Update is done in UpdateFormComponent and this component takes the id of the category to be updated from the TableComponent, sends it to UpdateFormComponent and then handles the alerts shown to the user
  ...
  // for Delete - Delete is done in this component after receiving the id of the category to be deleted from the TableComponent, and then handles the alerts shown to the user
